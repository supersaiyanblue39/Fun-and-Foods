...
function validateForm() {
    var x = document.forms["myForm1"]["n1"].value;
    var y = document.forms["myForm1"]["n3"].value;
    var z = document.forms["myForm1"]["n4"].value;
    if (x == "") {
		...
		<div class="registration-grids">
			<div class="reg-form">
				<div class="reg">
					 ...
					 <form name="myForm1" action="#" onsubmit="return validateForm()" method="post">
						 <ul>
                     ...
                     if(isset($_POST["s1"]))
                     {
					  ...
					  $d= $_POST["n4"];
					  $e= $_POST["n5"];
                      $p=mysqli_connect("localhost","root","gaur","fun_foods");
			...
			<div class="reg-right">
				 ...
				 <div class="strip"></div>
				 <p>We offer completely free account our new users along with suprising cool offers filled with loads of discounts.</p>
